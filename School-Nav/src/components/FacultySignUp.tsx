            ...
            {step === 1 ? (
                ...
                <div>
                  ...
                  <Select value={formData.department} onValueChange={(value: string) => handleChange('department', value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="CITHM">College of of International Tourism and Hospitality Management</SelectItem>
              ...
              <>
                <div>
                  ...
                  <Select value={formData.position} onValueChange={(value: string) => handleChange('department', value)}>
                    <SelectTrigger className="bg-gray-50 border-gray-300 focus:border-[#780302] focus:ring-[#780302]">
