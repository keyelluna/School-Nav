...
export default function MobileCampusMap({ highlightMode, onFeatureSelect }: MobileCampusMapProps) {
  const [zoom, setZoom] = useState(1.2); // Start slightly zoomed to fit screen width
  ...
  return (
    <div className="relative w-full h-full bg-gray-100 overflow-hidden flex flex-col">
      ...
      <motion.div
        ...
        className="absolute top-0 left-0 right-0 z-20 bg-white/95 backdrop-blur-sm shadow-md"
      >
      ...
      >
        ...
        >
          <div
            ref={mapRef}
            className="relative w-full h-full transition-transform origin-center"
            style={{
      ...
      <motion.div
        ...
        transition={{ duration: 0.4, ease: "easeOut" }}
        className="absolute right-4 bottom-20 z-20 flex flex-col gap-2"
      >
        <button
      ...
      <motion.div
        ...
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.4, ease: "easeOut" }}
        className="absolute bottom-0 left-0 right-0 z-20 bg-white/95 backdrop-blur-sm shadow-lg"
      >
