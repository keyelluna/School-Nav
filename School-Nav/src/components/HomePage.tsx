...
export default function HomePage({ userType, onLogout }: HomePageProps) {
  ...
  return (
    <div className="bg-white relative w-full min-h-screen">
      ...
      {/* Header */}
      <motion.header 
        className="bg-[maroon] text-white py-3 sm:py-4 px-3 sm:px-4 md:px-8 shadow-lg relative z-10"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-8">
        ...
        <motion.div
          ...
          className="mb-8 bg-white rounded-[10px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.1)] p-6"
        >
        ...
        <motion.div
          ...
          className="bg-white rounded-[10px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.1)] overflow-hidden mb-8"
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {facilitiesData.map((facility) => (
                    <motion.div
                      ...
                      className="bg-gray-50 rounded-lg overflow-hidden cursor-pointer hover:shadow-lg transition-all"
